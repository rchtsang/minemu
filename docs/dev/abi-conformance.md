...
| [`MINEMU-DEV1-BLOCK-001`-`009`](../platform/devices-v1.md#block-device) | Unit snapshot, deadline, DMA/LBA, shared busy/IRQ, independent media, unit errors, and persistence | `minemu-platform` ABI tests; `minemu-core` block/reset tests; `minemu-unicorn` UNIT MMIO test; `minemu-runtime` dual-flush/reset/path tests; [block case](../../minimum-tests/headless/block/test.toml); [unattached-unit case](../../minimum-tests/headless/block-unattached/test.toml) |
