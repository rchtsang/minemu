...
| [`MINEMU-DEV1-BLOCK-001`-`007`](../platform/devices-v1.md#block-device) | Snapshot, deadline, DMA/LBA, busy, IRQ, and persistence | `minemu-core` block tests; `minemu-runtime` flush/reset tests; [block case](../../minimum-tests/headless/block/test.toml) |
