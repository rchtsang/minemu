...
| BOOT-01 | Reset at Boot ROM, guest segment copy/BSS clear, boot info, and physical handoff | generic reset-preservation tests; minimum-template firmware check and headless smoke test |
